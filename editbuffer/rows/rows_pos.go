...
func (c RowsPos) Equals(other RowsPos) bool {
...
func (c *RowsPos) AdjustForDeletion(deleteStart, deleteEnd RowsPos) {
...
func (c *RowsPos) AdjustForInsertion(insertStart, insertEnd RowsPos) {
